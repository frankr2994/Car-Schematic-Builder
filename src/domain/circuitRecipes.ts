...
export const circuitRecipes: CircuitRecipe[] = [
  ...
  },
  {
    ...
    components: [
      ...
      { role: "switch", kind: "switch.toggle", name: "Headlight Dash Switch", zone: "Dash" },
    ...
    connections: [
      ...
      { fromRole: "fuse.out", toRole: "switch.in", color: "Red", gauge: "16", label: "Switch Feed" },
      { fromRole: "switch.out", toRole: "relay_low.86", color: "Yellow", gauge: "16", label: "Low Beam Trigger" },
      { fromRole: "switch.out", toRole: "relay_high.86", color: "Yellow", gauge: "16", label: "High Beam Trigger" },
  ...
  },
  {
    ...
    name: "Starter & Ignition System",
    description: "High-torque starter motor with integrated solenoid, multi-position keyed ignition switch, and high-amp battery cable",
